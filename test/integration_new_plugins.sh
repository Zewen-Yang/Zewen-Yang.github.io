...
# ...and with it off, the plugin costs nothing. Upstream relies on the template
# default (false) here; this site ships `protect_email: true` in _config.yml, so
# build the off case with an explicit override too.
